...
- соблюдение стандартов C11 и принципов структурного программирования;
- опыт разработки утилит командной строки на языке C;
- работа с текстовыми файлами (чтение, обрабатка и вывод текстовых данных);
- работа с регулярными выражениями для поиска и фильтрации данных;
- понимание работы с командной строкой и взаимодействие с файловой системой;
- сборка проекта с помощью Makefile, включая цели для компиляции и тестирования;
- разработка интеграционных тестов для проверки корректности работы утилит, сравнивая с поведением оригинальных утилит Bash.
